...
// }
   ...
   stage ('build'){
      ...
      sh 'BUILD_TYPE=ondemand; sudo /mnt/data/BuildScripts/copyKeys.sh Nougat; sudo /mnt/data/projects/Infra/Jenkins/scripts/copyAndroidAppsFromSMB.sh Nougat' + displayName
